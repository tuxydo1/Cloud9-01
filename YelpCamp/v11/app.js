...
/*Some middleware to ensure that the user object and flash messages are available in every template*/
/*(app.use calls this function for every route)*/
app.use(function(req, res, next){
   /*Whatever we put in res.locals is available in our templates*/
   res.locals.currentUser = req.user;
   /*Also make sure that the flash error messages are available wherever they are needed*/
